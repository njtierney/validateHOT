...
Finally, `validateHOT` also provides a function, `marksim` to calculate the assumed market share of a specified assortment. <code>validateHOT</code> currently provides market simulations based on share on preference or first choice rule. To specify which market simulation method to run, you can easily decide by specifying the <code>method</code> argument.
