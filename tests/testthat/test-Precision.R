...
test_that("Structure of Output", {
  expect_true(is.data.frame(Precision(data = HOT, id = 1, opts = c(2:9), choice = 10, None = 9)))
})

test_that("Structure of Output", {
  expect_equal(nrow(Precision(data = HOT, id = 1, opts = c(2:9), choice = 10, None = 9)), 1)
  expect_equal(ncol(Precision(data = HOT, id = 1, opts = c(2:9), choice = 10, None = 9)), 1)
})

test_that("Labeling correct", {
  expect_equal(colnames(Precision(data = HOT, id = 1, opts = c(2:9), choice = 10, None = 9)), "Precision")
})
...
test_that("Make sure test data is correct", {
  expect_equal(Precision(data = HOT, id = 1, opts = c(2:9), choice = 10, None = 9)[1, 1], 70.69)
})
...
test_that("Structure of Output", {
  expect_true(is.data.frame(Precision(data = HOT, id = 1, Group = 10, opts = c(2:9), choice = 11, None = 9)))
})

test_that("Structure of Output", {
  expect_equal(nrow(Precision(data = HOT, id = 1, Group = 10, opts = c(2:9), choice = 11, None = 9)), (length(unique(HOT$Group)) + 1))
  expect_equal(ncol(Precision(data = HOT, id = 1, Group = 10, opts = c(2:9), choice = 11, None = 9)), 2)
})

test_that("Labeling correct", {
  expect_equal(colnames(Precision(data = HOT, id = 1, Group = 10, opts = c(2:9), choice = 11, None = 9)), c("Group", "Precision"))
})
