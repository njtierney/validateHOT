...
test_that("Structure of Output", {
  expect_true(is.data.frame(MedAE(data = HOT, id = 1, opts = c(2:9), choice = 10)))
})

test_that("Structure of Output", {
  expect_equal(nrow(MedAE(data = HOT, id = 1, opts = c(2:9), choice = 10)), 1)
  expect_equal(ncol(MedAE(data = HOT, id = 1, opts = c(2:9), choice = 10)), 1)
})

test_that("Labeling correct", {
  expect_equal(colnames(MedAE(data = HOT, id = 1, opts = c(2:9), choice = 10)), "MedAE")
})
...
test_that("Wrong format Choice", {
  ...
  expect_error(MedAE(data = HO2, id = 1, opts = c(2:9), choice = 10))
})
...
test_that("MedAE() also working with data.frame not created with createHOT()", {
  ...
  expect_equal(nrow(MedAE(data = newHOT, id = 1, opts = c(2:5), choice = 6)), 1)
  expect_equal(ncol(MedAE(data = newHOT, id = 1, opts = c(2:5), choice = 6)), 1)
})
...
test_that("Structure of Output", {
  expect_true(is.data.frame(MedAE(data = HOT, id = 1, opts = c(2:9), choice = 11, Group = 10)))
})

test_that("Structure of Output", {
  expect_equal(nrow(MedAE(data = HOT, id = 1, opts = c(2:9), choice = 11, Group = 10)), (length(unique(HOT$Group)) + 1))
  expect_equal(ncol(MedAE(data = HOT, id = 1, opts = c(2:9), choice = 11, Group = 10)), 2)
})
...
test_that("MedAE() also working with data.frame not created with createHOT()", {
  ...
  expect_equal(nrow(MedAE(data = newHOT, id = 1, opts = c(2:5), choice = 6, Group = 7)), (length(unique(newHOT$Group)) + 1))
  expect_equal(ncol(MedAE(data = newHOT, id = 1, opts = c(2:5), choice = 6, Group = 7)), 2)
})
