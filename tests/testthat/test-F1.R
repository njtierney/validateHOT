...
test_that("Structure of Output", {
  expect_true(is.data.frame(F1(data = HOT, id = 1, opts = c(2:9), choice = 10, None = 9)))
})

test_that("Structure of Output", {
  expect_equal(nrow(F1(data = HOT, id = 1, opts = c(2:9), choice = 10, None = 9)), 1)
  expect_equal(ncol(F1(data = HOT, id = 1, opts = c(2:9), choice = 10, None = 9)), 1)
})

test_that("Labeling correct", {
  expect_equal(colnames(F1(data = HOT, id = 1, opts = c(2:9), choice = 10, None = 9)), "F1")
})


test_that("Test plausability of results", {
  expect_true(F1(data = HOT, id = 1, opts = c(2:9), choice = 10, None = 9)[1, 1] <= 100)
})
...
test_that("Wrong format Choice", {
  ...
  expect_error(F1(data = HOT2, id = 1, opts = c(2:9), choice = 10, None = 9))
})
...
test_that("No missings in output", {
  expect_false(base::anyNA(F1(data = HOT, id = 1, opts = c(2:9), choice = 10, None = 9)))
})
...
test_that("F1() also working with data.frame not created with createHOT()", {
  ...
  expect_equal(base::nrow(F1(data = newHOT, id = 1, opts = c(2:6), choice = 7, None = 6)), 1)
  expect_equal(base::ncol(F1(data = newHOT, id = 1, opts = c(2:6), choice = 7, None = 6)), 1)

  expect_false(base::anyNA(F1(data = newHOT, id = 1, opts = c(2:6), choice = 7, None = 6)))
  })
...
test_that("Structure of Output", {
  expect_true(is.data.frame(F1(data = HOT, id = 1, Group = 10, opts = c(2:9), choice = 11, None = 9)))
})

test_that("Structure of Output", {
  expect_equal(nrow(F1(data = HOT, id = 1, Group = 10, opts = c(2:9), choice = 11, None = 9)), (length(unique(HOT$Group)) + 1))
  expect_equal(ncol(F1(data = HOT, id = 1, Group = 10, opts = c(2:9), choice = 11, None = 9)), 2)
})

test_that("Labeling correct", {
  expect_equal(colnames(F1(data = HOT, id = 1, Group = 10, opts = c(2:9), choice = 11, None = 9)), c("Group", "F1"))
})


test_that("Test plausability of results", {

  Results <- F1(data = HOT, id = 1, Group = 10, opts = c(2:9), choice = 11, None = 9)
...
test_that("Wrong format Choice", {
  HOT2 <- HOT
  HOT2$choice <- as.character(HOT2$choice)
  expect_error(F1(data = HOT2, id = 1, Group = 10, opts = c(2:9), choice = 11, None = 9))
})
...
test_that("No missings in output", {
  expect_false(base::anyNA(F1(data = HOT, id = 1, Group = 10, opts = c(2:9), choice = 11, None = 9)))
})
...
test_that("F1() also working with data.frame not created with createHOT()", {
  ...
  expect_equal(nrow(F1(data = newHOT, id = 1, opts = c(2:6), choice = 7, None = 6, Group = 8)), (length(unique(newHOT$Group)) + 1))
  expect_equal(ncol(F1(data = newHOT, id = 1, opts = c(2:6), choice = 7, None = 6, Group = 8)), 2)

  expect_false(base::anyNA(F1(data = newHOT, id = 1, opts = c(2:6), choice = 7, None = 6, Group = 8)))
})
...
test_that("Right labels of 'Group' variable", {
  ...
  Results <- F1(data = HOT2, id = 1, Group = 10, opts = c(2:9), choice = 11, None = 9)
