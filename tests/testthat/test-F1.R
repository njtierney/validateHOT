...
test_that("Structure of Output", {
  expect_true(base::is.data.frame(f1(data = HOT, id = 1, opts = c(2:9), choice = 10, None = 9)))
})

test_that("Structure of Output", {
  expect_equal(base::nrow(f1(data = HOT, id = 1, opts = c(2:9), choice = 10, None = 9)), 1)
  expect_equal(base::ncol(f1(data = HOT, id = 1, opts = c(2:9), choice = 10, None = 9)), 1)
})

test_that("Labeling correct", {
  expect_equal(base::colnames(f1(data = HOT, id = 1, opts = c(2:9), choice = 10, None = 9)), "f1")
})
...
test_that("Labeling correct", {
  expect_equal(base::colnames(f1(data = HOT, id = 1, Group = 10, opts = c(2:9), choice = 11, None = 9)), c("Group", "f1"))
})
...
test_that("f1() also working with data.frame not created with createHOT()", {
  ...
  expect_equal(base::nrow(f1(data = newHOT, id = 1, opts = c(2:6), choice = 7, None = 6, Group = 8)), (base::length(base::unique(newHOT$Group)) + 1))
  expect_equal(base::ncol(f1(data = newHOT, id = 1, opts = c(2:6), choice = 7, None = 6, Group = 8)), 2)
